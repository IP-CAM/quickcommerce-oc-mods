...
$token = '66fe6170b47f7b4fb2ba94bb4aea19a242fe';
...
$oauth_consumer_key = 'qyprdnfn1gyeY71yUqXbh6mIOZLdjT';
$oauth_consumer_secret = 'mR9asomcqvJz4Ssf4lU81KSZ2zQWFUrqpr2WkGgK';
...
$quickbooks_oauth_url = 'http://php5519.deathstar/quickbooks-php-master/docs/partner_platform/example_app_ipp_v3/oauth.php';

// This is the URL to forward the user to after they have connected to IPP/IDS via OAuth
$quickbooks_success_url = 'http://php5519.deathstar/quickbooks-php-master/docs/partner_platform/example_app_ipp_v3/success.php';

// This is the menu URL script 
$quickbooks_menu_url = 'http://php5519.deathstar/quickbooks-php-master/docs/partner_platform/example_app_ipp_v3/menu.php';

// This is a database connection string that will be used to store the OAuth credentials 
// $dsn = 'pgsql://username:password@hostname/database';
// $dsn = 'mysql://username:password@hostname/database';
$dsn = 'mysqli://root:v@der!4201986@localhost/quickcommerce';		
